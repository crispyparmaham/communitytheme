<div class="termin-list-start">
	...
	if ($custom_query->have_posts()) :
		while ($custom_query->have_posts()) :
			...
			// Termin-Daten
			$startdatum = date_i18n("d. F Y", strtotime(get_field('startdatum', $post->ID)));
			$enddatum = date_i18n("d. F Y", strtotime(get_field('enddatum', $post->ID)));
					...
					<div class="termin-info-wrap">
						...
						<?php else : ?>
							<span class="post-listing-item-info-date-end no-padding-left">
								bis zum <?php echo esc_html($enddatum); ?>
							</span>
						<?php endif; ?>
					</div>
